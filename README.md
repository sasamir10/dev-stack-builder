...
1. Global styles, font, color variables, and page container
2. Navbar, including desktop and mobile layout
3. Hero section using `logo-text.png` and `banner-stack.png`
4. `technologies.json` data file
5. Technology card component
6. Technology grid and loading state
7. “Your Stack” sidebar
8. Add, duplicate-warning, remove, and remove-all functionality with Toastify
9. Footer
10. Responsive refinements and final polish

Each step will include only the files/code needed for that part, plus exactly where to paste it.
